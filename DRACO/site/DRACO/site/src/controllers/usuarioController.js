...
function cadastrar(req, res) {
    ...
    if (nome == undefined) {
        ...
        usuarioModel.cadastrar(nome, sobrenome, dtnascimento, sexo, email, senha, elemento)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
...
function puxarElemento(req, res) {
    // var elemento = req.body.elementServer;
    usuarioModel.puxarElemento()
        .then(function (resultado) {
            if (resultado.length > 0) {
                res.status(200).json(resultado);
            } else {
